...
public class XianyuWebSocketClient extends WebSocketClient {
            ...
            try {
                                ...
                                if (dataList != null && !dataList.isEmpty()) {
                                    ...
                                    for (int i = 0; i < dataList.size(); i++) {
                                        ...
                                        if (syncData != null && syncData.containsKey("data")) {
                                            ...
                                            // 解密数据
                                            String decryptedData = com.xianyusmart.utils.MessageDecryptUtils.decrypt(encryptedData);
                ...
                if (messageData.containsKey("body")) {
                    ...
                    if (body instanceof String) {
                        ...
                        String decryptedBody = com.xianyusmart.utils.MessageDecryptUtils.tryDecrypt(bodyStr);
    ...
    private void sendAckMessage(Map<String, Object> messageData) {
        try {
            ...
            if (headers.containsKey("mid")) {
                ...
                // 生成mid
                String mid = com.xianyusmart.utils.XianyuDeviceUtils.generateMid();
    ...
    private String generateUuid() {
        return com.xianyusmart.utils.XianyuDeviceUtils.generateUuid();
    }
}
